# Head-to-head model comparison (2026-06-24)
...
![Model comparison](eval-head-to-head-20260624-compare.png)


**ROC curves**

![ROC curves](eval-head-to-head-20260624-roc.png)


**LightGBM feature importance**

![LightGBM feature importance](eval-head-to-head-20260624-importance.png)


**Metric 3: AUC by volatility regime**

![Metric 3: AUC by volatility regime](eval-head-to-head-20260624-regime.png)


**Metric 2: equity curve (after costs)**

![Metric 2: equity curve (after costs)](eval-head-to-head-20260624-equity.png)
