# Head-to-head model comparison (2026-06-27)
...
![Model comparison](eval-head-to-head-20260627-compare.png)


**ROC curves**

![ROC curves](eval-head-to-head-20260627-roc.png)


**LightGBM feature importance**

![LightGBM feature importance](eval-head-to-head-20260627-importance.png)


**Metric 3: AUC by volatility regime**

![Metric 3: AUC by volatility regime](eval-head-to-head-20260627-regime.png)


**Metric 2: equity curve (after costs)**

![Metric 2: equity curve (after costs)](eval-head-to-head-20260627-equity.png)
