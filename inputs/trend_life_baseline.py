...
PANELS = {
    "4h": ("inputs/binance-data/dataset_4h_allmarket.parquet", "crypto 4h"),
    "1d": ("inputs/binance-data/dataset_1d_allmarket.parquet", "crypto daily"),
    "eq1d": ("inputs/alpaca-data/dataset_eq1d_allmarket.parquet", "US equities daily"),
}
