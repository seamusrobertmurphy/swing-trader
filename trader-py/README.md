...
![Guarded MACD preview for BTC/USDT, hourly](outputs/macd_lab/preview_btc.png)
...
[MACD dashboard](outputs/macd_lab/macd-dashboard.html), the
[Fibonacci dashboard](outputs/fib_lab/fib-dashboard.html), and the
[confluence dashboard](outputs/confluence_lab/confluence-dashboard.html) open in
any browser.
...
![MACD divergence and convergence quadrants](outputs/macd_lab/divergence_matrix.png)
...
![Fibonacci preview with auto-anchored swing](outputs/fib_lab/preview_fib.png)
...
![Confluence preview with vote agreement and composite score](outputs/confluence_lab/preview_confluence.png)
