# Bench run, 22 September 2026 19:28
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| RF max_depth=3 n_estimators=37 | 0.4867 | 0.4919 | 0.4842 | 0.4890 | n/a | n/a | 0.06231 | 0.04773 | 1.114 | 1.102 | 1.011 | passes |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| RF | 0.4932 | 0.4911 | 0.06356 | 0.500 | 1.144 | 0.238 | 0.541 |
...
- `figures/bench-20260922-192858-reliability.png`, stated probability against what happened, on the blind period
- `figures/bench-20260922-192858-importance.png`, how much each column mattered, by permutation on the blind period


![stated probability against what happened, on the blind period](figures/bench-20260922-192858-reliability.png)

![how much each column mattered, by permutation on the blind period](figures/bench-20260922-192858-importance.png)
...
An elastic net at l1_ratio 0.7 over 2,000 training rows. lambda.min 0.0026074 keeps 13; lambda.1se 0.050623 keeps 0. Screened at lambda.min.

| feature | coefficient |
| --- | ---: |
| f_hr_ema_fast_mid | +0.2975 |
| f_wc_mom_30 | -0.2824 |
| f_hr_mom_24 | +0.2343 |
| f_wc_mom_60 | -0.2257 |
| f_wc_bb_pos | +0.1795 |
| f_hr_ema_mid_slow | -0.1595 |
| f_btc_corr_168 | -0.1214 |
| f_wc_rsi | +0.0935 |
| f_wc_rv_long | +0.0524 |
| f_hr_mom_6 | -0.0451 |
| f_hr_vol_ratio | +0.0390 |
| f_hr_bb_pos | -0.0196 |
| f_btc_rel_mom_24 | +0.0105 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| raw | 0.2169 | 0.6030 | 0.2449 | 0.06203 | 0.00452 | 0.1859 |
| Platt | 0.0258 | 0.0978 | 0.1894 | 0.00237 | 0.00062 | 0.1859 |
