# Bench run, 22 September 2026 21:37
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| RF max_depth=3 n_estimators=37 | 0.4864 | 0.4917 | 0.4838 | 0.4887 | n/a | n/a | 0.06128 | 0.04842 | 1.113 | 1.101 | 1.011 | passes |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| RF | 0.4923 | 0.4896 | 0.06453 | 0.501 | 1.142 | 0.232 | 0.529 |
...
- `figures/bench-20260922-213757-reliability.png`, stated probability against what happened, on the blind period
- `figures/bench-20260922-213757-importance.png`, how much each column mattered, by permutation on the blind period


![stated probability against what happened, on the blind period](figures/bench-20260922-213757-reliability.png)

![how much each column mattered, by permutation on the blind period](figures/bench-20260922-213757-importance.png)
...
An elastic net at l1_ratio 0.7 over 2,000 training rows. lambda.min 0.0028191 keeps 13; lambda.1se 0.050623 keeps 0. Screened at lambda.min.

| feature | coefficient |
| --- | ---: |
| f_hr_ema_fast_mid | +0.3042 |
| f_wc_mom_30 | -0.2795 |
| f_wc_mom_60 | -0.2276 |
| f_hr_mom_24 | +0.2201 |
| f_wc_bb_pos | +0.1643 |
| f_hr_ema_mid_slow | -0.1383 |
| f_btc_corr_168 | -0.1220 |
| f_wc_rsi | +0.0815 |
| f_wc_rv_long | +0.0502 |
| f_hr_vol_ratio | +0.0389 |
| f_hr_mom_6 | -0.0366 |
| f_btc_rel_mom_24 | +0.0114 |
| f_hr_bb_pos | -0.0105 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| raw | 0.2219 | 0.5445 | 0.2462 | 0.06028 | 0.00299 | 0.1859 |
| Platt | 0.0511 | 0.1294 | 0.1896 | 0.00510 | 0.00216 | 0.1859 |
