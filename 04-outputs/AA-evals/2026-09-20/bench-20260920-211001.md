# Bench run, 20 September 2026 21:10
...
Listing dates read from each symbol's first archive: LINK/USDT 2019-01-16, LTC/USDT 2017-12-13, MATIC/USDT 2019-04-26.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| RF max_depth=4 min_samples_leaf=200 n_estimators=150 | 0.4224 | 0.4275 | 0.3640 | 0.3808 | n/a | n/a | 0.00831 | 0.00322 | 0.976 | 1.006 | 1.012 | passes |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| RF | 0.4463 | 0.3865 | 0.01119 | 0.570 | 0.998 | 0.002 | 0.531 |
...
| --- | ---: | ---: | ---: | ---: | --- |
| RF | 3 | 0 | 0.00 | 0.6 | not met |

## Figures

Drawn from the Choose Figures and Signal engines settings on this run's own rows, and written beside this record.

- `figures/bench-20260920-211001-reliability.png`, stated probability against what happened, on the blind period
- `figures/bench-20260920-211001-importance.png`, how much each column mattered, by permutation on the blind period


![stated probability against what happened, on the blind period](figures/bench-20260920-211001-reliability.png)

![how much each column mattered, by permutation on the blind period](figures/bench-20260920-211001-importance.png)
