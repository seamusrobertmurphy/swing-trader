...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| LogReg.glm | 0.4333 | 0.4324 | 0.3755 | 0.3795 | n/a | n/a | 0.00084 | 0.00326 | 0.994 | 1.002 | 0.998 | passes |
| RF max_depth=3 n_estimators=37 | 0.4293 | 0.4326 | 0.3737 | 0.3848 | n/a | n/a | 0.00483 | 0.00226 | 0.985 | 1.002 | 1.008 | passes |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| LogReg.glm | 0.4258 | 0.3659 | 0.00423 | 0.575 | 0.996 | 0.000 | 0.556 |
| RF | 0.4289 | 0.3717 | 0.00546 | 0.575 | 1.003 | 0.001 | 0.499 |
...
An elastic net at l1_ratio 0.7 over 2,000 training rows. lambda.min 0.014387 keeps 8; lambda.1se 0.042909 keeps 0. Screened at lambda.min.

| feature | coefficient |
| --- | ---: |
| f_btc_corr_168 | -0.1049 |
| f_hr_rv_ratio | -0.0577 |
| f_hr_rv_long | +0.0403 |
| f_hr_mom_12 | +0.0346 |
| f_hr_rsi | +0.0299 |
| f_wc_ema_mid_slow | -0.0273 |
| f_hr_ema_fast_mid | +0.0197 |
| f_wc_atr_pct | +0.0184 |
