# Edge diagnostics (2026-09-08) -- 5m all-market
...
![selectivity](edge-diagnostics-selectivity-5m-20260908.png)

| threshold | trades | after-cost / trade | total after-cost | win rate |
| --- | --- | --- | --- | --- |
| 0.450 | 2,487,844 | -0.204% | -507936.3% | 0.39 |
| 0.491 | 1,702,029 | -0.199% | -339268.0% | 0.40 |
| 0.532 | 576,714 | -0.189% | -109068.8% | 0.41 |
| 0.573 | 144,223 | -0.177% | -25596.2% | 0.42 |
| 0.614 | 37,589 | -0.168% | -6322.5% | 0.43 |
| 0.655 | 8,841 | -0.172% | -1516.4% | 0.43 |
| 0.695 | 1,760 | -0.175% | -307.3% | 0.43 |
| 0.736 | 252 | -0.118% | -29.8% | 0.46 |
| 0.777 | 16 | -0.146% | -2.3% | 0.44 |
| 0.818 | 0 | - | - | - |
| 0.859 | 0 | - | - | - |
| 0.900 | 0 | - | - | - |

**Selectivity reading:** after-cost return per trade rises but stays NEGATIVE at every threshold (-0.204% -> best -0.118% on 252 trades), and the trade count collapses toward the top. The model RANKS well but the frame still loses to fees at every operating point -- selectivity does not rescue it. The lever is a coarser decision frame, new information, or cross-sectional framing, NOT a higher threshold and NOT a model retrain on selectivity.
