...
step "1/3 catastrophe stop" "$PY" 03-inputs/alpaca_trade.py check
step "2/3 mark to market"   "$PY" 03-inputs/alpaca_trade.py status
step "3/3 write report"     "$PY" 03-inputs/alpaca_daily_report.py
